...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head><title>Kokeru | Landing Page</title>
        <meta charset="UTF-8">
        ...
        <body>
              ...
              @if (Route::has('login'))
                <div class="w3-display-middle w3-text-white" style="text-align: center">
                  ...
                  <span class="w3-large">Sistem kontrol kebersihan ruangan</span><br>
                    @auth
                        <a href="{{ url('/home') }}" class="w3-button w3-round-xxlarge w3-padding-large w3-large w3-margin-top w3-hover-white" style="background-color: #15e0ae"><b>Home</b></a>
                    @else
                        <a href="{{ route('login') }}" class="w3-button w3-round-xxlarge w3-padding-large w3-large w3-margin-top w3-hover-white" style="background-color: #15e0ae"><b>Login</b></a>

                        @if (Route::has('register'))
                            <a href="{{ route('register') }}" class="w3-button w3-round-xxlarge w3-padding-large w3-large w3-margin-top w3-hover-white" style="background-color: #427ffc"><b>Register</b></a>
                        @endif
                    @endauth
                </div>
              @endif
              ...
              <div class="row">
                ...
                <div class="col">
                      <div class="card" style="width: 17rem;">
                        <img class="card-img-top" src="{{$rm->foto_ruang}}" alt="">
                        <div class="card-body">
                          <h2 class="card-title">{{$rm->nama_ruang}}</h2> 
                          <p class="card-text">Gedung {{$rm->gedung}} -  {{$rm->petugas}}</p>
                          @if($rm->status =='BELUM')
                            <a class="btn btn-outline-danger disabled btn-sm" style="color: red">{{$rm->status}}</a>
                            <a class="btn btn-primary btn-sm" style="color:white">Edit</a>
                          @else
                            <a class="btn btn-outline-success disabled btn-sm" style="color :rgb(40, 224, 40)">{{$rm->status}}</a>
                            <a href="" class="btn btn-info btn-sm" style="color: white"> Cek Foto</a>
                            <a class="btn btn-primary btn-sm" style="color:white">Edit</a>
                            @endif                     
                        </div>
                      </div>
            ...
            <div class="w3-container" style="padding:128px 16px" id="about">
              <h3 class="w3-center"><b>Apa itu Kokeru?</b></h3>
              <p class="w3-center w3-large">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore.</p>
